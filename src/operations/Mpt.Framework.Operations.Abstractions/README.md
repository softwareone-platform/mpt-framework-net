# Mpt.Framework.Operations.Abstractions

Pure abstractions for the [Mpt.Framework.Operations](https://www.nuget.org/packages/Mpt.Framework.Operations) engine. Contains only interfaces and POCOs — **no third-party runtime dependencies**, no MassTransit, no EF Core.
...
```
dotnet add package Mpt.Framework.Operations.Abstractions
```

Install the full engine package `Mpt.Framework.Operations` only in your **composition root** (Worker / API host).
