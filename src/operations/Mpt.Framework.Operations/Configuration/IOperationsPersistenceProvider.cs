...
/// <summary>
/// Pluggable persistence provider for the operations engine. The main package ships an in-memory
/// implementation; a companion package may register an alternative (for example,
/// <c>Mpt.Framework.Operations.EntityFrameworkCore</c> registers a SQL Server / EF Core provider).
/// </summary>
public interface IOperationsPersistenceProvider
{
    /// <summary>
    /// Called once when <c>AddOperations</c> runs, after operation descriptors are known and before
...
/// <param name="OperationName">Stable operation name as provided to <c>OperationsBuilder.Register</c>.</param>
