...
namespace Mpt.Framework.Operations.Utility;
...
internal static class OperationSagaTypeBuilder
{
    ...
    {
        AssemblyName assemblyName = new("DynamicOperationsAssembly");
        AssemblyBuilder assemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.Run);
        return assemblyBuilder.DefineDynamicModule("DynamicOperationsModule");
    }
