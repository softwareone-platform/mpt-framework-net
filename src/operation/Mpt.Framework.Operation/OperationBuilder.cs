...
public class OperationBuilder
{
    ...
    internal OperationBuilder(IServiceCollection services, string moduleCode, OperationSettings settings)
    {
    ...
    /// (e.g. <c>Mpt.Framework.Operation.EFCore</c>) to install a durable provider.
    /// </summary>
    public IOperationPersistenceProvider Persistence { get; set; } = new InMemoryOperationPersistenceProvider();

    public OperationBuilder Register<TOperation>(string name, Action<ProcessingOptions>? configure = null)
