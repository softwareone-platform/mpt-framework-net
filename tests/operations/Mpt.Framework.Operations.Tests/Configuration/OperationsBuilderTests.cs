...
namespace Mpt.Framework.Operations.Tests.Configuration;

public class OperationsBuilderTests
{
    [Fact]
    ...
    public void Register_ValidOperationInConsumeMode_RegistersHandlerInServices()
    {
        ...
        var builder = new OperationsBuilder(services, "test", new OperationSettings { Mode = OperationsMode.ConsumeAndDispatch });
    ...
    {
        var services = new ServiceCollection();
        var builder = new OperationsBuilder(services, "test", new OperationSettings { Mode = OperationsMode.Dispatch });
    ...
    private static OperationsBuilder NewBuilder() =>
